...
namespace PersonalTracker.Models.FinanceModels.Database
{
    ...
    internal interface IDatabaseInteraction
    {
        ...
        /// <returns>Returns true if successful</returns>
        Task<bool> AddTransaction(FinancialTransaction transaction, Account account);
        ...
        /// <returns>Returns true if successful</returns>
        Task<bool> DeleteTransaction(FinancialTransaction transaction, Account account);
        ...
        /// <returns>Returns true if successful</returns>
        Task<bool> ModifyTransaction(FinancialTransaction newTransaction, FinancialTransaction oldTransaction);
