...
namespace PersonalTracker.Models.FinanceModels.Database
{
    ...
    internal class SQLiteDatabaseInteraction : IDatabaseInteraction
    {
        ...
        /// <returns>Returns true if successful</returns>
        public Task<bool> AddTransaction(FinancialTransaction transaction, Account account)
        {
            SQLiteCommand cmd = new SQLiteCommand
            {
                CommandText =
        ...
        /// <returns>Returns true if successful</returns>
        public Task<bool> DeleteTransaction(FinancialTransaction transaction, Account account)
        {
            SQLiteCommand cmd = new SQLiteCommand
            {
                CommandText =
        ...
        /// <returns>Returns true if successful</returns>
        public Task<bool> ModifyTransaction(FinancialTransaction newTransaction, FinancialTransaction oldTransaction)
        {
            SQLiteCommand cmd = new SQLiteCommand
            {
