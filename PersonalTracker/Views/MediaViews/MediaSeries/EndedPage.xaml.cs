...
namespace PersonalTracker.Views.MediaViews.MediaSeries
{
    ...
    public partial class EndedPage
    {
        ...
        {
            _series = AppState.CurrentUser.Media.AllSeries.ToList().FindAll(series => series.Status == SeriesStatus.Ended).OrderBy(series => series.Name).ToList();
        ...
        private void EndedPage_OnLoaded(object sender, RoutedEventArgs e) => RefreshItemsSource();
